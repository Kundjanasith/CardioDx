...
st.set_page_config(
    page_title="CardioTwin-AI v3.0.3 Unified Demo",
    layout="wide",
)
...
def build_payload(result, phase_label, start_sec, end_sec):
    return {
        "version": "CardioTwin-AI v3.0.3 unified demo",
...
st.title("CardioTwin-AI v3.0.3 Unified Clinical Demo Dashboard")
st.caption(
...
with tabs[4]:
    ...
    if not payload:
        ...
        <body>
        <h1>CardioTwin-AI v3.0.3 Unified Demo Report</h1>
        ...
        with col1:
            st.download_button(
                ...
                file_name="cardiotwin_v303_unified_report.json",
                mime="application/json",
            )
        with col2:
            st.download_button(
                ...
                file_name="cardiotwin_v303_unified_report.html",
                mime="text/html",
            )
