...
Path("apps/streamlit_cardiotwin_unified_v304_real_inference.py").write_text(app, encoding="utf-8")
print("DONE: apps/streamlit_cardiotwin_unified_v304_real_inference.py")
